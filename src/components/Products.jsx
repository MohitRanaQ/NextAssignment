...
console.log(categories,"categories",productsData,"products" , selectedCategory,"selected cate")
  ...
  return (
    <div>
      ...
      <div className=" mb-4 flex justify-between">  <input
          type='text'
          placeholder='Search'
          value={searchTerm}
            className="rounded"
        ...
        <button className="text-sm text-slate-500 ml-2"
